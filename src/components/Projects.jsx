...
const projectsData = [
  ...
  {
    id: 7,
    title: "Upper Crust Pizza Website",
    description: "A fully responsive React + Vite + Tailwind website built for a real Milwaukee-area pizzeria, featuring intuitive navigation, dynamic menu sections, and embedded Google Maps.",
    csTitle: "Digital Transformation for Local Business Growth",
    csDescription: "Designed and launched a modern digital storefront to **increase online visibility**, improve ordering convenience, and drive repeat customers. Implemented responsive UI, clear menu browse paths, and optimized load speeds — enhancing customer engagement and supporting the client’s marketing efforts.",
