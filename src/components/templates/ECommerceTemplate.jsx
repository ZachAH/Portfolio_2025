    ...
    >
      <div className="relative h-64 w-full overflow-hidden bg-gray-100 dark:bg-gray-800">
        <img 
          ...
          alt="E-Commerce Storefront Template Mockup"
      ...
      <div className="p-8">
        ...
        <p className="text-gray-400 mb-6 text-sm leading-relaxed">
          A minimalist, highly-converting e-commerce template. Features a beautiful product grid, cart functionality, and seamless checkout flow design.
        </p>
        
        <div className="flex flex-wrap gap-2 mb-8">
          <span className="text-xs px-2 py-1 rounded-md bg-gray-800 text-gray-300 border border-gray-700">Next.js</span>
          <span className="text-xs px-2 py-1 rounded-md bg-gray-800 text-gray-300 border border-gray-700">Stripe</span>
